...
let tva=0;
    switch (name) {
      case 'tva': {
        tva=this.editField;
        this.interdiagnostic[id].puhtr=diag.puht-((diag.remise/100)*diag.puht);
        this.interdiagnostic[id].mnttva=diag.puhtr*(tva/100);
        this.interdiagnostic[id].puttc=Number(diag.puhtr)+Number(diag.mnttva);
